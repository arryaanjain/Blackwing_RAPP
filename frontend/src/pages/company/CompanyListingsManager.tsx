    ...
    return (
      <DashboardLayout>
        <div className="bg-red-900/20 backdrop-blur-sm border border-red-800/40 rounded-lg p-6 text-center">
          <p className="text-red-300 mb-4">Only companies can manage listings. Please switch to a company profile.</p>
        </div>
      </DashboardLayout>
    );
  }
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-blue-300">Create and manage your procurement listings</p>
          </div>
          <Link
            to={ROUTES.PROTECTED.COMPANY.LISTINGS_CREATE}
        ...
        <div className="bg-blue-900/20 backdrop-blur-sm border border-blue-800/40 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-blue-200 mb-2">Visibility</label>
              <select
                ...
                <div className="text-right">
                  ...
                  {listing.closes_at && (
                    <p className="text-sm text-blue-400">
                      Closes {new Date(listing.closes_at).toLocaleDateString()}
                    </p>
                  )}
                </div>
              </div>
        ...
        {listings.length === 0 && !loading && (
          <div className="bg-blue-900/20 backdrop-blur-sm border border-blue-800/40 rounded-lg p-12 text-center">
            <div className="text-blue-300 text-lg mb-4">No listings found</div>
            <Link
              to={ROUTES.PROTECTED.COMPANY.LISTINGS_CREATE}
...
export default CompanyListingsManager;
