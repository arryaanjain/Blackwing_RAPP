...
const MOCK_LISTINGS = [
  {
    ...
    description: 'Looking for bulk industrial cleaning supplies with eco-friendly certification. We need a reliable Vendor who can provide consistent quality and timely delivery. Products must meet environmental standards.',
    quantity: 500,
    maxPrice: 25000,
    isPublic: true,
  ...
  },
  {
    ...
    description: 'Looking for Company network switches and routers for new data center deployment. Must be compatible with existing Cisco infrastructure.',
    quantity: 15,
    maxPrice: 35000,
    isPublic: true,
