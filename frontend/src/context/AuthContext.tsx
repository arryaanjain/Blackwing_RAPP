...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  const createCompanyProfile = async (profileData: any): Promise<Profile> => {
    try {
      const response = await axios.post(API_CONFIG.ENDPOINTS.PROFILES_COMPANY, profileData);
  ...
  const createVendorProfile = async (profileData: any): Promise<Profile> => {
    try {
      const response = await axios.post(API_CONFIG.ENDPOINTS.PROFILES_VENDOR, profileData);
