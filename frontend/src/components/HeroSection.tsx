      ...
      <Container className="text-center relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 mb-8 backdrop-blur-md">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">Mainnet Protocol v4.0</span>
          </div>
          ...
          <h1 className="text-6xl md:text-8xl lg:text-9xl font-black tracking-tighter mb-8 leading-[0.9] text-shimmer">
            {title.includes('Blockchain') ? (
              <>TRUSTED <br /><span className="text-gradient-brand">PROCUREMENT</span></>
            ) : title}
          </h1>
