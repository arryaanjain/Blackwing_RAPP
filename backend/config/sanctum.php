...
return [
    ...
    */
    ...
    | considered expired. This is separate from the main expiration setting
    | and is used specifically for short-lived access tokens.
    |
    */

    'access_token_expiration' => (int) env('SANCTUM_ACCESS_TOKEN_EXPIRATION', 15), // 15 minutes
